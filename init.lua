...
require('lazy').setup({
      ...
      require('telescope').setup {
        ...
        pickers = {
          lsp_document_symbols = {
            prompt_position = 'top',
            symbol_width = 80, -- Increase this value to show longer symbol names
            layout_config = {
              width = 0.9, -- Make the telescope window wider (90% of screen)
              preview_width = 0.5, -- Adjust the preview width if needed
            },
          },
        },
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'mason-org/mason.nvim', opts = { ensure_installed = { 'cmakelang', 'cmakelint' } } },
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'clang-format', -- Maybe not necessary because contained in Clangd?
        'autopep8',
        -- 'isort', -- for python but we don't use it at work
      })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- any other, such as 'tokyonight-night', 'tokyonight-storm', or 'tokyonight-day'.
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'cmake', 'cpp', 'bash', 'c', 'python', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
