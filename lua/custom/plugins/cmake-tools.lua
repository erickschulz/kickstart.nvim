return {
  ...
  dependencies = {
    ...
    -- Optional dependencies based on your executor/runner choice
    'akinsho/toggleterm.nvim', -- if using toggleterm executor/runner
    'stevearc/overseer.nvim', -- if using overseer executor/runner
  },
  config = function()
